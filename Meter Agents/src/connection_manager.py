...
class ConnectionManager:
    ...
    def _class_name_to_type(self,
                            class_name: str) -> Optional[Type[BaseConnection]]:
        connection_map = {
    ...
    def get_model_providers(self) -> List[str]:
        ...
        try:
            return [
                ...
                and getattr(conn, "is_llm_provider", False)
            ]
        except Exception as e:
    ...
    def list_actions(self, connection_name: str) -> List[str]:
        ...
        logger.warning(
            f"⚠️ Connection '{connection_name}' does not expose actions.")
        return []
